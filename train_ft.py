...
IMG_MEAN = np.array((98.933625, 108.389025, 99.84372), dtype=np.float32)
...
def get_arguments():
    ...
    parser.add_argument("--data_dir_pse", type=str, default='../pseudo/',
                        help="target val dataset path.")              
...
def main():
    ...
    exp_name = 'Src2SH_ft_lr'+str(args.learning_rate)+'_ep'+str(args.num_epoch)+'_'+str(args.input_size.split(',')[0]+timename)
